...
def upload_resume(request):
    if request.method == "POST" and request.FILES.get("resume"):
        ...
        try:
            ...
            context = {
                "info": {
                    "full_name": extracted_info.group(1).strip() if extracted_info else "Not found.",
                    ...
                    "skills": {
                        ...
                        "tools": "Extracted tools here",  # Extract tools from the response
                        "interests": "Extracted fields of interest here"  # Extract fields of interest from the response
                    }
                },
                "education": {
