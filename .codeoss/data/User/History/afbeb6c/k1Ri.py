...
def predict_fraud(request):
    ...
    if request.method == 'POST':
        try:
            ...
            # Get prediction (now with Vertex AI integration)
            ...
            error_msg = str(e)
            if 'Vertex AI' in error_msg:  # Handle API-specific errors
                error_msg = f"Vertex AI error: {error_msg}. Check API key and endpoint."
            if request.content_type == 'application/json':
