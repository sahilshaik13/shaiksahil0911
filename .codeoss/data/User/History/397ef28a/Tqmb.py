...
class FraudPrediction(models.Model):
    ...
    # Enhanced ML tracking fields (including Vertex AI-specific metrics)
    ...
    # Vertex AI integration fields (for AI-generated content detection and embeddings)
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['ai_generation_score']),  # New index for AI metrics
            models.Index(fields=['embedding_similarity']),  # New index for AI metrics
        ]
